...
void open_terminal(tap_dance_state_t *state, void *user_data) {
    if (state->count == 1) {
...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_J] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, open_terminal, dance_j_reset)
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [FN2] = LAYOUT_69_ansi(
        ...
        _______, _______,  KC_PGUP, KC_UP,   _______, _______, _______, KC_NUM,  KC_P7,   KC_P8,   KC_P9,    KC_SLSH,  KC_ASTR,  KC_PMNS,           _______,
        _______, KC_HOME,  KC_LEFT, KC_DOWN, KC_RGHT, KC_END,           KC_BSPC, SFT_4,   CTL_5,   ALT_6,    GUI_PLS,  KC_DEL,   _______,          _______,
        _______,           KC_PGDN, _______, _______, _______, _______, _______, KC_P1,   KC_P2,   KC_P3,    KC_PEQL,  _______,  _______, _______,
    ...
    [FN1] = LAYOUT_69_ansi(
        ...
        _______, _______,  _______,           _______,          _______,  LLOCK,            _______,           _______,            _______, KC_PGDN, _______),
