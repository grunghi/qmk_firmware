...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [FN2] = LAYOUT_69_ansi(
        ...
        _______, _______,  _______,  KC_UP,   _______, _______, _______,  KC_7,    KC_8,    KC_9,    KC_SLSH,  KC_ASTR,  KC_PMNS,  _______,          _______,
        _______, _______,  KC_LEFT,  KC_DOWN, KC_RGHT, _______,           _______, KC_4,    KC_5,    KC_6,     _______,  _______,  _______,          _______,
        _______,           _______,  _______, _______, _______, BAT_LVL,  BAT_LVL, KC_0,    KC_1,    KC_2,     KC_3,     _______,  _______, _______,
