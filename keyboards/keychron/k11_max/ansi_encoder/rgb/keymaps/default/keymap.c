...
void send_log(qk_tap_dance_state_t *state, void *user_data) {
    if (state->count == 1) {    
...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_LOG] = ACTION_TAP_DANCE_FN(send_log),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [FN3] = LAYOUT_69_ansi(
        ...
        _______, _______, _______,    _______,     _______,     _______, _______, _______, _______,    _______, _______,    _______, _______, _______,          _______,
        _______, _______, TD(TD_ADR), TD(TD_NAME), TD(TD_MAIL), _______,          _______, TD(TD_TEL), _______, TD(TD_LOG), _______, _______, _______,          _______,
